...
class GetSmallMarketerSerializer(serializers.ModelSerializer):
    class Meta:
        model = Marketer
        fields = ['user_id', 'username', 'first_name', 'last_name', 'balance', 'withdrawal_threshold', 'commission', 'gender', 'reference_link', 'can_withdraw']
...
class GetProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ['id', 'price', 'title', 'type', 'description', 'marketers']
    
    marketers = GetSmallMarketerSerializer(many=True, read_only=True)
